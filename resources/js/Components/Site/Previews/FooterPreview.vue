...
<template>
    <footer 
        ...
        :style="{ 
            ...
            borderTop: style.borderTop ? '1px solid rgba(255,255,255,0.1)' : 'none',
        }"
        id="footer"
    >
        <div class="max-w-6xl mx-auto">
            ...
            >
                <a
                    ...
                    class="w-10 h-10 flex items-center justify-center rounded-full transition-colors hover:opacity-80"
            ...
            <div class="text-center">
                <p class="text-sm opacity-80">
                    © {{ copyrightYear }} {{ content.copyrightText || 'Todos os direitos reservados' }}
                </p>
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    class="text-sm opacity-60 hover:opacity-100 mt-2 inline-block"
                >
